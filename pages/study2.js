export default function Study2() {
  ...
  <div className="mx-auto max-w-screen-md px-4 md:px-8">
      ...
      <img src="/images/Logo完成.png" loading="lazy" alt="Photo by Minh Pham" className="h-full w-full object-cover object-center" />
    </div>
    <h1 className="mb-4 text-center text-2xl font-bold text-gray-800 sm:text-3xl md:mb-6">STUDY Tailwind</h1>
